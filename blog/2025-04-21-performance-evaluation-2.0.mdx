---
title: 'Performance Evaluation of Trino 468, Spark 4.0.0-RC2, and Hive 4 on MR3 2.0 using the TPC-DS Benchmark'
description: 'Performance Evaluation of Trino 468, Spark 4.0.0-RC2, and Hive 4 on MR3 2.0 using the TPC-DS Benchmark'
...
In this article, we report the results of evaluating the performance of the following systems
using the 10TB TPC-DS Benchmark.
...
which significantly outperformed Hive on Tez.
...
See the [quick start guides](/docs/quick/) to try Hive on MR3.
