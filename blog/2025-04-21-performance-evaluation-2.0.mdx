...
description: '10TB TPC-DS benchmark results of Trino 468, Spark 4.0.0-RC2, and Hive 4 on MR3 2.0'
...
<Head>
  ...
  <meta name="description" content="Compare the 10TB TPC-DS benchmark results of Trino 468, Spark 4.0.0-RC2, and Hive 4 on MR3 2.0." />
</Head>

In this article, we evaluate the performance of the following systems
on the 10TB TPC-DS Benchmark,
focusing on Trino TPC-DS, Spark TPC-DS, and Hive TPC-DS scenarios:
